...
export class AddIndexing1770102044502 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "idx_product_images_main" ON "product_images" ("productId", "isMain") `);
        await queryRunner.query(`CREATE INDEX "idx_product_images_product" ON "product_images" ("productId") `);
