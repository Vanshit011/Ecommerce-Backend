...
export class RemoveOrderStatus1769689178171 implements MigrationInterface {
  name = 'RemoveOrderStatus1769689178171';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "orders" ADD "orderStatus" character varying NOT NULL DEFAULT 'SHIPPED'`,
    );
  }
}
