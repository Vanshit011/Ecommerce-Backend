...
export class RemoveProductFields1770885282523 implements MigrationInterface {
  name = 'RemoveProductFields1770885282523';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    // Table product_variants already exists
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "products" ADD "sale_price" numeric(10,2)`,
    );
    await queryRunner.query(
      `ALTER TABLE "products" ADD "stock_qty" integer NOT NULL DEFAULT '0'`,
    );
    await queryRunner.query(
      `ALTER TABLE "products" ADD "sku" character varying(50) NOT NULL`,
    );
    await queryRunner.query(
