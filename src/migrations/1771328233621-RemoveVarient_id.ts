...
export class RemoveVarientId1771328233621 implements MigrationInterface {
    name = 'RemoveVarientId1771328233621'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "cart_items" ADD "variant_id" character varying(100)`);
        await queryRunner.query(`ALTER TABLE "order_items" DROP COLUMN "variant_id"`);
        await queryRunner.query(`ALTER TABLE "order_items" ADD "variant_id" character varying(100)`);
    }
