...
export class AddPrductImagesTable1770095996900 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "products" ADD "stockQty" integer NOT NULL DEFAULT '0'`);
        ...
        await queryRunner.query(`ALTER TABLE "products" ADD "availability" "public"."products_availability_enum" NOT NULL DEFAULT 'instock'`);
        ...
        await queryRunner.query(`ALTER TABLE "products" ADD "metaTitle" character varying`);
        await queryRunner.query(`ALTER TABLE "products" ADD "metaDescription" character varying`);
