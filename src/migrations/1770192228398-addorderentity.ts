...
export class Addorderentity1770192228398 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "order_items" ADD "size" character varying`);
        await queryRunner.query(`ALTER TABLE "order_items" ADD "color" character varying`);
        await queryRunner.query(`ALTER TABLE "order_items" ADD "variantId" character varying`);
        await queryRunner.query(`ALTER TABLE "order_items" ADD "productSnapshot" jsonb`);
